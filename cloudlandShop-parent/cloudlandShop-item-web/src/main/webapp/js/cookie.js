...
$(function(){
	...
	if($(".topMenu .d2 .dd").length){
		$(".topMenu .d2 .dd").append('<div class="client-promo"><a href="http://app.cloudlandshop.cn#trackref=sfbest_Uhead_Uhead_head_app2" target="_blank" rel="nofollow">先摇券 后买单</a></div>');
	}
	if($(".f_ios").length){
		$(".f_ios").find("li:first").html('<a target="_blank" href="http://app.cloudlandshop.cn">手机客户端</a>');
	}
	...
	if(ZnowTime >= 1414771200000 && ZnowTime<=1416239999000){
		$('.index_rfloat').html('<a href="/html/activity/1414059494.html" target="_blank"><img src="http://p.cloudlandshop.cn/gold/images/20141113/20141113111801929.jpg"></a><div class="J_rclose">关闭</div>');
		$('.index_rfloat').show();
	}
	$('.app-android').attr('href','http://android.cloudlandshop.cn/sfandroid');
	//右侧广告位关闭
