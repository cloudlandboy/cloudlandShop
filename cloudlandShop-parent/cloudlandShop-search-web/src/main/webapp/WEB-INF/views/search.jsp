...
<div class="linknav">
	<div class="schArticle">
		<a href="/article/search?keyword=%E6%9C%88%E9%A5%BC" target="_blank">找到和“<span>${itemSearchData.query}</span>”相关的文章<span
			id="articlenum">${itemSearchData.totalPages }</span>篇&gt;&gt;
		</a>
	</div>
	<div class="breadcrumb">
		<span>全部结果&nbsp;&gt;&nbsp;${itemSearchData.query}</span>
	</div>
</div>
  ...
  <div class="main-box">
   ...
   <a id="prolist-id"></a>
    <div class="r-filter">
      <div class="f-sort">
        <div class="pagin">
          <span class="txt"><span class="n">${itemSearchData.page }</span>/${itemSearchData.totalPages }</span>
          <span class="prev">上一页</span><span class="next">下一页</span>       	</div>
        <div class="total">共<span>${itemSearchData.recourdCount }</span>个商品</div>
      </div>
    </div>
    ...
    <div class="p-list">
      <ul class="list-all">
         <c:forEach items="${itemSearchData.itemList }" var="item">
         <li>
            <div class="l-wrap">
				<div class="pic">
