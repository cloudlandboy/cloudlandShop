...
<body>
		<!-- header -->
		<div class="header">
			<a href="http://www.cloudlandshop.cn"><img src="/images/logo.png" border="0" /><span>欢迎注册</span></a>
		</div>
...
<div class="reg_main reg_border regTab" id="perDiv">
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post"  >
			...
			<span  class="regM" style="margin-left:29px">
				...
				<a href="https://passport.cloudlandshop.cn/xy.html" target="_blank"  class="checkTitle">我已阅读并同意<font style="font-size:12px;">《云梦商城用户注册协议》</font></a>
			</span>
    ...
    <div class="ui-reg-tip"><a href="http://help.cloudlandshop.cn/140/6788.html" target="_blank">了解更多>></a></div>
</div>
...
<!--mainOver-->
		...
		<div class="footer">
			<span>
				<a href="http://www.cloudlandshop.cn/www/379/5109.html" rel="nofollow" class="footerlink1">关于我们</a> | 
				<a href="http://www.cloudlandshop.cn/www/380/5116.html" rel="nofollow" class="footerlink1">联系我们</a> | 
				<a href="http://www.cloudlandshop.cn/www/381/5117.html" rel="nofollow" class="footerlink1">招聘人才</a> | 
				<a href="http://www.cloudlandshop.cn/www/330/2705.html" rel="nofollow" class="footerlink1">友情链接</a> | 
				<a href="http://supplier.cloudlandshop.cn/supplierApply" rel="nofollow" class="footerlink1">供应商申请</a>
			</span>
			<p> 
				北京云梦电子商务有限公司<br />
				北京市公安局顺义分局备案11011302000890号|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">京ICP备12011349号</a>|<a href="http://www.cloudlandshop.cn/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br />
				Copyright© 云梦商城 cloudlandshop.cn 版权所有<br /> 
			</p>
		</div>
		<!-- /footer -->
<script type="text/javascript">
	var REGISTER={
		...
		doSubmit:function() {
			$.post("/user/registerService",$("#regForm_mod").serialize(), function(data){
				if(data.status == 200){
